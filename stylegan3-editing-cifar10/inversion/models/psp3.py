...
from inversion.models.encoders import restyle_psp_encoders
...
class pSp(nn.Module):
    ...
    def __init__(self, opts):
        ...
        self.face_pool = torch.nn.AdaptiveAvgPool2d((32, 32))
    ...
    def load_weights(self):
        if self.opts.checkpoint_path is not None:
            ...
            self.decoder = SG3Generator(checkpoint_path="/cluster/home/bgunders/stylegan3-editing/pretrained_models/sg2c10-32.pkl").decoder
