...
dataset_paths = {
	...
	'cifar10_train': Path('/cluster/home/bgunders/cifar10/train'),
	'cifar10_test': Path('/cluster/home/bgunders/cifar10/test'),

	'cifar10_at_train': Path('/cluster/home/bgunders/cifar10_all_train/train'),
	'cifar10_at_test': Path('/cluster/home/bgunders/cifar10_all_train/test'),
}

model_paths = {
	# models for backbones and losses
	'ir_se50': Path('/cluster/home/bgunders/stylegan3-editing/pretrained_models/model_ir_se50.pth'),
