...
default_parameters = {"dataset": [dataset], "optim": ["sgd"], "epochs": [180], "batch_size": [32], "learning_rate": [0.1], "momentum": [0.9], "weight_decay": [1e-4], "gamma":[0.1, 0.1 ** (1/2)],  "random_seed": seeds}
...
def dict_to_command(command_dict):
    commands = ["sbatch --time 1-0 --ntasks=4 --mem-per-cpu=8G --gpus=rtx_2080_ti:1  --wrap \"PYTHONPATH=/cluster/home/bgunders/deeplearningproject /cluster/scratch/bgunders/conda_envs/sg3exl/bin/python3.9 main.py"]
